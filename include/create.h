...
enum ValueType { INTEGER_TYPE = 1, DOUBLE_TYPE, STRING_TYPE, IDENTIFIER_TYPE, INVALID_TYPE };
...
Statement* create_FORStatement(Expression* before, Expression* condition, Expression* after,
                               Statement_list* list);
...
Binary_Expression* createBinaryExpression(enum ExpressionAction action, Expression* left,
                                          Expression* right);
